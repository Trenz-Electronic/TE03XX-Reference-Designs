# 
# Project automation script for blinker-TE0320-1800 
# 
# Created for ISE version 13.2
# 
# This file contains several Tcl procedures (procs) that you can use to automate
# your project by running from xtclsh or the Project Navigator Tcl console.
# If you load this file (using the Tcl command: source blinker-TE0320-1800.tcl), then you can
...
set myProject "blinker-TE0320-1800"
set myScript "blinker-TE0320-1800.tcl"
...
proc add_source_files {} {
   ...
   xfile add "blinker.vhd"
   xfile add "system.ucf"

   # Set the Top Module as well...
   project set top "Behavioral" "blinker"
...
proc set_process_props {} {
   ...
   project set "Work Directory" "C:/Projects/Trenz/repos/TE03XX-Reference-Designs/blinkin-TE0320/xst" -process "Synthesize - XST"
   ...
   project set "Output File Name" "blinker" -process "Generate IBIS Model"
