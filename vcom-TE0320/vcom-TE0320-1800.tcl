# 
# Project automation script for vcom-TE0320-1800 
# 
# Created for ISE version 13.2
# 
# This file contains several Tcl procedures (procs) that you can use to automate
# your project by running from xtclsh or the Project Navigator Tcl console.
# If you load this file (using the Tcl command: source vcom-TE0320-1800.tcl), then you can
...
set myProject "vcom-TE0320-1800"
set myScript "vcom-TE0320-1800.tcl"
...
proc set_process_props {} {
   ...
   project set "Project Description" "Sample project for TE0320 module, which show communication with Cypress FX2 microcontroller in Virtual COM mode"
   ...
   project set "Working Directory" "../vcom-TE0320"
   ...
   project set "Work Directory" "C:/Projects/Trenz/FX2_vcom/vcom-TE0320/xst" -process "Synthesize - XST"
