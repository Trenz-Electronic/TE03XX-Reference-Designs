...
ngdbuild -intstyle ise -dd ../synth/_ngo -uc mig_23.ucf -p xc3s1600efg320-4 mig_23.ngc mig_23.ngd >> ise_flow_results.txt

map -intstyle ise -detail -p xc3s1600efg320-4 -cm speed -pr off -k 4 -c 100 -o mig_23_map.ncd mig_23.ngd mig_23.pcf >> ise_flow_results.txt
